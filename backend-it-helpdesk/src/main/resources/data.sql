...
INSERT INTO tickets(CATEGORY_ID, CLOSED_AT, CREATED_AT, DETAIL_ID, FIX_ID, ID, PRIORITY, USER_ID)
VALUES ( 'CASE00001', null, current_timestamp, 'CASE00001', 'CASE00001', 'CASE00001','P4_INDIVIDUAL', 'Test_Manager'),
       ( 'CASE00002', null, current_timestamp, 'CASE00002', 'CASE00002', 'CASE00002','P2_DEPARTEMENT', 'Test_Agent'),
       ( 'CASE00003', null, current_timestamp, 'CASE00003', 'CASE00003', 'CASE00003','P1_ORGANIZATION', 'Test_Client');

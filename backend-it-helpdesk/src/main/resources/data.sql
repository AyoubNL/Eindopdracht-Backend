...
VALUES ('Test_Manager', '$2a$10$oh2jnssxP9pT/TcHPfhXb.au5/Fn1.7/AO.A1dRKA1jhunmuybd0.', 'MANAGER',
        'test_manager@novi.nl'),
...
VALUES ('CASE00001', null, current_timestamp, 'CASE00001', 'CASE00001', 'P4_INDIVIDUAL', 'Test_Manager'),
       ('CASE00002', null, current_timestamp, 'CASE00002', 'CASE00002', 'P2_DEPARTEMENT', 'Test_Agent'),
       ('CASE00003', null, current_timestamp, 'CASE00003', 'CASE00003', 'P1_ORGANIZATION', 'Test_Client');
